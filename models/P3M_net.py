...
# from util import *
from models.backbones.resnet_mp import *
...
class P3M_Net(nn.Module):
    ...
    def forward(self, input):
        ...
        return global_sigmoid, local_sigmoid, global_sigmoid_side2, global_sigmoid_side1, global_sigmoid_side0, fusion_sigmoid
